...
const pastaPesto = [
	...
	{type: "Dairy", name: "Mozzarella", quantity: 300, unit: "Gr"},
...
const pastaBroccoli = [
	{type: "Vegetables", name: "Broccoli", quantity: 1, unit: "Pc"},
	{type: "Vegetables", name: "Sun Dried Tomatoes", quantity: 200, unit: "Gr"},
	{type: "Condiments", name: "Red Pesto", quantity: 200, unit: "Gr"},
	{type: "Dairy", name: "Feta", quantity: 300, unit: "Gr"},
	{type: "Pastry", name: "Farfalle", quantity: 400, unit: "Gr"},
];

let pb = document.getElementById("pb");
pb.addEventListener("click", function () {
	dishName = pb.innerHTML;
	bdish = pastaBroccoli;
	addDish();
});

const eggBeans = [
	{type: "Vegetables", name: "Beans", quantity: 300, unit: "Gr"},
	{type: "Dairy", name: "Egg", quantity: 4, unit: "Pcs"},
	{type: "Meat", name: "Breaded Chicken", quantity: 2, unit: "Pcs"},
	{type: "Vegetables", name: "Sweet Potatoes", quantity: 300, unit: "Gr"},
];

let eb = document.getElementById("eb");
eb.addEventListener("click", function () {
	dishName = eb.innerHTML;
	bdish = eggBeans;
	addDish();
});

const courgetteRedPesto = [
	{type: "Vegetables", name: "Courgette", quantity: 4, unit: "Pcs"},
	{type: "Dairy", name: "Mozzarella", quantity: 100, unit: "Gr"},
	{type: "Condiments", name: "Red Pesto", quantity: 200, unit: "Gr"},
];

let crp = document.getElementById("crp");
crp.addEventListener("click", function () {
	dishName = crp.innerHTML;
	bdish = courgetteRedPesto;
	addDish();
});

const shopskaSalad = [
	{type: "Vegetables", name: "Cucumber", quantity: 1, unit: "Pc"},
	{type: "Dairy", name: "Feta", quantity: 100, unit: "Gr"},
	{type: "Vegetables", name: "Tomatoes", quantity: 200, unit: "Gr"},
	{type: "Vegetables", name: "Olives", quantity: 100, unit: "Gr"},
];

let shs = document.getElementById("shs");
shs.addEventListener("click", function () {
	dishName = shs.innerHTML;
	bdish = shopskaSalad;
	addDish();
});
